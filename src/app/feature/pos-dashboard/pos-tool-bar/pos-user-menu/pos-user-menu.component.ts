...
@Component({
  selector: 'app-pos-user-menu',
  templateUrl: './pos-user-menu.component.html',
  styleUrls: ['./pos-user-menu.component.scss']
})
export class PosUserMenuComponent implements OnInit {
  isOpen = false;
