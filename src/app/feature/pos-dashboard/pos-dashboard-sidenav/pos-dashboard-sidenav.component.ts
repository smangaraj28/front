...
@Component({
  selector: 'app-pos-dashboard-sidenav',
  templateUrl: './pos-dashboard-sidenav.component.html',
  styleUrls: ['./pos-dashboard-sidenav.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PosDashboardSidenavComponent implements OnChanges, OnInit, OnDestroy {
