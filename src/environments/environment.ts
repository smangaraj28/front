...
export const apiurls = {
    ...
    all_api_url: 'http://127.0.0.1:8085',
    // 'https://e294sbftrc.execute-api.ap-south-1.amazonaws.com/acdev',
    // Individual routes
    url_regis: 'http://127.0.0.1:8085',
    url_acsignupcallbk: 'http://127.0.0.1:8085',
    url_login: 'http://127.0.0.1:8085',
    url_aclogincallbk: 'http://127.0.0.1:8085',
};
...
export const installation = {
    standaloneinstall: true,  //This decisides the login screen to be shown
